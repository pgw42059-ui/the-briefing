...
export const mockAssetDetails: Record<string, AssetDetail> = {
  ...
  VIX: {
    ...
    nameKr: 'VIX (공포지수)',
    description: '\'월스트리트 공포지수\'로 불리는 S&P 500 옵션의 30일 내재변동성 지수입니다. 시장 참여자들의 향후 변동성 기대를 실시간으로 반영하며, 주식 시장 하락 시 급등하는 역의 상관관계를 보입니다. VIX 20 이하는 안정, 30 이상은 공포, 40 이상은 패닉 구간으로 분류하며 단기 과매도 신호로도 활용됩니다.',
    exchange: 'CBOE (시카고옵션거래소)',
    tradingHours: '미국 주식시장 거래 시간 기준',
    contractSize: '직접 투자 불가 (ETF·선물로 간접 투자)',
    tickInfo: '지수값 (매매 불가)',
    tags: ['변동성', '공포지수', '리스크 지표', 'S&P500 옵션'],
    keyLevels: { support: 15, resistance: 30 },
    relatedEvents: ['FOMC 금리결정', 'S&P 500 급등락', '지정학적 이벤트'],
    chartData: generateChartData(20, 30, 0.03),
  },
  USDKRW: {
    symbol: 'USDKRW',
    name: 'USD/KRW',
    nameKr: '원달러환율',
    description: '미국 달러 대비 한국 원화 환율로, 한국 트레이더에게 가장 중요한 환율 지표입니다. Fed 금리 정책·미국 경제지표·한국 무역수지·외국인 자금 흐름이 주요 변수입니다. 원화 약세(환율 상승) 시 수출 기업 실적에 호재가 되지만 수입 물가를 올려 인플레이션 압력을 높입니다. 해외선물 트레이더는 달러 결제 손익의 원화 환산 시 이 환율을 직접 활용합니다.',
    exchange: 'OTC 외환시장 (서울·뉴욕)',
    tradingHours: '24시간 (월 09:00 ~ 토 06:00 KST, 서울 외환시장 09:00~15:30)',
    contractSize: '단위 없음 (현물환)',
    tickInfo: '1원 단위 호가',
    tags: ['원달러', '환율', 'Fed 금리', '한국 무역수지', '외국인 자금'],
    keyLevels: { support: 1400, resistance: 1480 },
    relatedEvents: ['FOMC 금리결정', '비농업 고용 (NFP)', '한국 무역수지 발표'],
    chartData: generateChartData(1455, 30, 0.004),
  },
  DXY: {
    symbol: 'DXY',
    name: 'US Dollar Index',
    nameKr: '달러인덱스',
    description: '유로(57.6%)·엔(13.6%)·파운드(11.9%)·캐나다달러·스웨덴 크로나·스위스 프랑 6개 주요 통화 대비 미 달러화의 상대 가치를 나타내는 지수입니다. Fed 금리 정책·미국 경제 지표·글로벌 위험 회피 심리에 따라 움직이며, 원자재 가격(골드·오일)과 강한 역의 상관관계를 보입니다. 달러 강세는 신흥국 통화·원자재에 하방 압력을 가합니다.',
    exchange: 'ICE Futures U.S.',
    tradingHours: '월~금 07:00 ~ 익일 06:00 KST',
    contractSize: '지수 (DXY 선물: $1,000 × 지수)',
    tickInfo: '최소 0.005pt = $5',
    tags: ['달러 강세', 'Fed 정책', '안전자산', '원자재 역상관'],
    keyLevels: { support: 100, resistance: 106 },
    relatedEvents: ['FOMC 금리결정', '비농업 고용 (NFP)', 'CPI 발표'],
    chartData: generateChartData(104, 30, 0.002),
  },
};
...
export const mockQuotes: FuturesQuote[] = [
  ...
  { symbol: 'VIX', name: 'CBOE Volatility Index', nameKr: 'VIX', price: 19.54, change: -1.23, changePercent: -5.92, high: 21.02, low: 19.30, volume: '—' },
  ...
  { symbol: 'USDKRW', name: 'USD/KRW', nameKr: '원달러환율', price: 1458.50, change: -5.30, changePercent: -0.36, high: 1465.20, low: 1455.80, volume: '—' },
  { symbol: 'DXY', name: 'US Dollar Index', nameKr: '달러인덱스', price: 104.18, change: 0.32, changePercent: 0.31, high: 104.45, low: 103.92, volume: '—' },
